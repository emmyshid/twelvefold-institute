...
export async function emailWelcomeNewUser(args: {
  ...
  const html = shell({
    ...
    body: `
      ...
      <p style="margin:0 0 18px;">The fastest way to feel what pattern literacy actually is, is to use it on something real in your life. Visit <a href="https://twelvefold.institute/#try-it" style="color:#7C3AED;font-weight:600;">the brief reading on our homepage</a> and describe a situation that keeps repeating — anything you've been turning over. You'll get a pattern name, a phase, and a teaching.</p>
      <p style="margin:0 0 18px;">For a full reading — the pattern named, the phase placed, the alignment read, the participation prescribed, six traditions weighed in — you work with a certified Twelvefold practitioner. We'll connect you with one when you're ready.</p>
